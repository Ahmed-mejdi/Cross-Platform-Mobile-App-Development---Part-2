...
class NoteService {
  ...
  Future<List<Document>> getNotes({String? userId}) async {
    try {
      ...
      // Add sorting by $createdAt descending (Appwrite system field)
  ...
  Future<Document> createNote(Map<String, dynamic> data) async {
    try {
      // Don't add timestamps - Appwrite handles this automatically
      final noteData = {
        ...data,
      };
  ...
  Future<Document> updateNote(String noteId, Map<String, dynamic> data) async {
    try {
      // Don't add updated timestamp - Appwrite handles this automatically
      final noteData = {
        ...data,
      };
